...
public class BaseDialog extends Dialog {
    ...
    public BaseDialog setmPositiveButtonClickListener(DialogInterface.OnClickListener listener) {
        this.positiveButtonClickListener = listener;
        return this;
    }

    public BaseDialog setmNegativeButtonClickListener(DialogInterface.OnClickListener listener) {
